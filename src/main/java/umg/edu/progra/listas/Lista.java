...
public class Lista {
    ...
    public void ordenarLista() {
        if (primero == null || primero.enlace == null) {
            return; // Si la lista está vacía o tiene un solo elemento, no hay nada que ordenar
        }
        ...
        while (actual != null) {
            ...
            while (siguiente != null) {
                if (siguiente.dato < menor.dato) {
                    menor = siguiente; // Encuentra el nodo con el menor valor
                }
                siguiente = siguiente.enlace;
            }

            // Intercambia los valores entre actual y menor
